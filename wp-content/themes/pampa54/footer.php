                    ...
                    <div class="row gutter-y-50">
                        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                            <div class="footer-widget footer-widget--about">
                                <h2 class="footer-widget__title" style="text-transform: none; font-weight: 300;">A Premium Meat distribution company, located in Miami, Fl, US.</h2>                       <p><strong>PAMPA54</strong> is a company founded by a visionary entrepreneur driven by passion, integrity, and a deep-rooted connection to the world of meat. At <strong>PAMPA54</strong>, we pride ourselves on offering only the highest quality meat products. Our selection features the renowned Argentine Angus beef, celebrated globally for its superior 
marbling, tenderness, and rich flavor. We ensure that each cut meets our rigorous standards.</p>         
                            </div>
                        </div>
                        <div class="col-lg-2 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                            ...
                            <div class="footer-widget footer-widget--contact">
                                ...
                                <div class="footer-widget__contact">
                                    <ul class="list-unstyled footer-widget__info">
										<li><span class="fa fa-home"></span>5930 NW 99th Ave, Suite 11. Doral, Fl 33178. United States</li>
                                        <li><span class="icon-paper-plane"></span> <a href="mailto:info@pampa54.com">info@pampa54.com</a></li>
                ...
                <div class="container">
                    <div class="main-footer__bottom__inner">
                        <p class="main-footer__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> | Designed by: <img src="<?php echo get_template_directory_uri();?>/assets/images/first.png"  alt="">
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:info@pampa54.com">info@pampa54.com</a>
                </li>
                <li>
                    <i class="fa fa-phone-alt"></i>
                    <a href="tel:+17863269846">+1 (786) 326-9846</a>
                </li>
            </ul>
