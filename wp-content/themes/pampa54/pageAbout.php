...
<?php get_header(); ?>
        ...
        <div class="sec-title sec-title--center">
                    ...
                    <h2 class="sec-title__title" style=" font-size:80px; ">A LEGACY OF QUALITY AND TRADITION</h2>
                </div>
            <div class="container">
            ...
            <div class="container-fluid">
                <div class="gallery-instagram__grid">
                    ...
                    <div class="gallery-instagram__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="gallery-instagram__image">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/gallery/gallery-ingreso.png" alt="">
                            <a href="#" class="gallery-instagram__image__link">
                    ...
                    <div class="gallery-instagram__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="800ms">
                        <div class="gallery-instagram__image">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/gallery/gallery-escalera.png" alt="">
                            <a href="#" class="gallery-instagram__image__link">
