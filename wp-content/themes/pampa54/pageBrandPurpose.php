...
<?php get_header(); ?>
        <section class="page-header">
            ...
            <div class="container">
                <h2 class="page-header__title">Brand Purpose</h2>
        ...
        <section class="about-three section-space" id="about">
            <div class="container">
                <div class="row gutter-y-60">
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/assets/images/gallery/gallery-instagram-3.jpg" alt="" class="about-three__image__two">
                    ...
                    <div class="col-lg-8 wow fadeInRight" data-wow-duration="1500ms">
                        <div class="about-three__content">
                            <div class="sec-title @@extraClassName">
                                ...
                                <h2 class="sec-title__title">BRAND PURPOSE TITLE</h2>
                            </div>
