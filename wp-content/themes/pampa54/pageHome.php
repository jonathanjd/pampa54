...
shared experience of savoring our authentic Argentinean chorizos.</p>
                            ...
                            <div class="about-three__bottom">
                                <a href="<?php echo _ABOUTURL_; ?>" class="pampa-btn">
                                    ...
                                    <span class="pampa-btn__hover"></span>
                                    <span class="pampa-btn__hover"></span>
                                    <span class="pampa-btn__text">know about us</span>
            ...
            <div class="container-fluid">
                <div class="gallery-instagram__grid">
                    ...
                    <div class="gallery-instagram__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="gallery-instagram__image">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/gallery/gallery-instagram-2.jpg" alt="">
                            <a href="#" class="gallery-instagram__image__link">
                                <span class="icon-instagram"></span>
                            </a>
                        </div>
                    ...
                    <div class="gallery-instagram__item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="gallery-instagram__image">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/gallery/gallery-instagram-4.jpg" alt="">
                            <a href="#" class="gallery-instagram__image__link">
                                <span class="icon-instagram"></span>
                            </a>
                        </div>
