(function ($) {
  ...
  // Date Picker
  if ($(".pampa-datepicker").length) {
    $(".pampa-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accordion
  if ($(".pampa-accordion").length) {
    var accordionGrp = $(".pampa-accordion");
  ...
  function thmOwlInit() {
    // owl slider
    let pampaowlCarousel = $(".pampa-owl__carousel");
    if (pampaowlCarousel.length) {
      pampaowlCarousel.each(function () {
        let elm = $(this);
    ...
    let pampaowlCarouselNav = $(".pampa-owl__carousel--custom-nav");
    if (pampaowlCarouselNav.length) {
      pampaowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let pampaowlCarouselWithCounter = $(
      ".pampa-owl__carousel--with-counter"
    );
    if (pampaowlCarouselWithCounter.length) {
      pampaowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="pampa-owl__carousel__counter"><span class="pampa-owl__carousel__counter__current"></span> / <span class="pampa-owl__carousel__counter__total"></span></div>'
            );
            elm
              .find(".pampa-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".pampa-owl__carousel__counter__total")
  ...
  //Strech Column
  function pampa_stretch() {
    var i = $(window).width();
    $(".row .pampa-stretch-element-inside-column").each(function () {
      var $this = $(this),
