		...
		"margin": 0
                ...
                <div class="item">
                    <div class="hero-slider-two__item">
                        <div class="hero-slider-two__bg" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/products/gaucho.png);"></div>
                        <div class="container">
                            <div class="row">
                ...
                <div class="item">
                    <div class="hero-slider-two__item">
                        <div class="hero-slider-two__bg" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/products/chorizos.jpg);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-12 col-xl-10 col-lg-10 mx-auto">
                                    <div class="hero-slider-two__content">
                ...
                <div class="item">
                    <div class="hero-slider-two__item">
                        <div class="hero-slider-two__bg" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/products/corte2.png);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-12 col-xl-10 col-lg-10 mx-auto">
                                    <div class="hero-slider-two__content">
